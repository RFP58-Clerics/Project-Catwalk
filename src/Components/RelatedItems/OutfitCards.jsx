...
function OutfitCards({ item, setStorage }) {
  ...
  return styles.name && (
    <div className="card">
      <button type="button" className="card-button related-button" onClick={removeItem}>
        <img className="card-button-img" src="https://img.icons8.com/windows/32/000000/xbox-x.png" alt="Unavailable" />
      </button>
      <div className="card-grid">
        <img className="img" src={styles.photos[0].thumbnail_url} alt="Unavailable" />
